...
//     // Get.put(GetCartProductController(), );
...
//   // String? token = Get.find<AuthProvider>().token;
//   String? token = Provider.of<AuthProvider>(navigatorKey.currentContext!).token;
//
//   Map<String, String> commonHeader = {
...
//     (predicate) => false,
//   );
//   await Provider.of<AuthProvider>(navigatorKey.currentContext!).logOut();
// }
//
// onSocketException() {
//    Get.snackbar(
